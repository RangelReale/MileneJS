...
inline void duv_ref_setup(duk_context *ctx) {
  ...
  if (duk_has_prop_string(ctx, -1, "refs") != 0) {
	  duk_pop(ctx);
	  return;
  }
...
inline int duv_ref(duk_context *ctx) {
  int ref;
...
inline void duv_push_ref(duk_context *ctx, int ref) {
  if (!ref) {
...
inline void duv_unref(duk_context *ctx, int ref) {
